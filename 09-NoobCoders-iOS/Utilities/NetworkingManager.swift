...
class NetworkingManager {
    ...
    static func handleCompletionForContestsData(completion: Subscribers.Completion<Publishers.Decode<AnyPublisher<Data, Error>, [AllContestModel], JSONDecoder>.Failure>) {
        switch completion {
        case .finished:
            break
